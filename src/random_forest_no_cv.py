...
for experiment in experiments:
    ...
    t_init = time()
    log_path = f"./logs/no_cv2_random_forest_{experiment}.txt"
    ...
    split_index = [0 if x in x_val else -1 for x in x_train]
    # print(split_index)
    ...
    # Save model
    joblib.dump(best_model, f'no_cv_best_random_forest_model_{experiment}.pkl')
