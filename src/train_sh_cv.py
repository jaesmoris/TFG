...
with open("/home/msiau/workspace/asdf/src/logs/train/sh/cross_validation/landraces_fold", 'w') as file:
    file.write(" ")

for i_fold, fold in enumerate(folds):
    save_path = f"/home/msiau/workspace/asdf/models/saved/sh/cross_validation/landraces_fold_{i_fold}"
    log_path = f"/home/msiau/workspace/asdf/src/logs/train/sh/cross_validation/landraces_fold_{i_fold}"
    train_index = fold[0]
    test_index = fold[1]
    data = dataset.data
    ...
    model = GrainClassifierSH(l_max, n_classes)
